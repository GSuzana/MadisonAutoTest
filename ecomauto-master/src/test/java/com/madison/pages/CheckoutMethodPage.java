...
public class CheckoutMethodPage extends PageObject {
    ...
    public void clickOnContinueButton(){guest.click();}

    public void inputUsername(String keyword){usernameInput.sendKeys(keyword);}

    public void inputPassword(String keyword){passwordInput.sendKeys(keyword);}
